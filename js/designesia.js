/* --------------------------------------------------
 * © Copyright 2025 - Моринский подворак by INazarov
 * --------------------------------------------------*/
(function ($) {
  "use strict";
...
document.querySelector('header').classList.add('clone');
  ...
  var x = parseFloat($('.bg-loop').css('background-position-x'));
  $('.bg-loop').css('background-position', (x - 1) + 'px 0');
